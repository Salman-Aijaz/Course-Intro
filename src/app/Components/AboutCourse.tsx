...
const AboutCourse = () => {
  return (
    <>    
    <Navbar/>
   <div className='container flex items-center justify-normal xl:pl-0 max-w-screen-md' id='AboutCourse'>
        <div className='ml-0 mr-0 mt-2 pr-0 pl-0 md:ml-0  lg:ml-0 md:mr-0 lg:mr-0 xl:mr-0'>
