  ...
  const HeroSection = ({ scrollToCourse }: { scrollToCourse:any }) => {
    return (
      <div className="flex flex-col justify-evenly items-center lg:py-20 lg:flex-row px-4 lg:px-0 dark:bg-gradient-to-b dark:from-[rgba(24,56,129,1)] dark:to-zinc-950">
        <div className="sm:w-5/6 lg:w-1/3 my-8 lg:my-0">
          ...
          <div className="my-6 dark:text-zinc-300">
        ...
        <div className="w-full sm:max-w-md lg:w-96 dark:bg-gradient-to-r bg-gray-50 dark:from-[#172335] dark:to-[#101c36] border rounded-md p-4 flex flex-col gap-8">
          {sections.map((section, index) => (
            <div className="flex gap-2 dark:text-zinc-300" key={index}>
              <section.icon className="w-8 h-12 text-[#191919] dark:text-zinc-300" />
              <div>
