  ...
  return (
    ...
    dark:bg-gradient-to-b dark:from-[rgba(24,56,129,1)] dark:to-zinc-950">
      <div className="lg:w-2/5 my-8 lg:my-0">
        <h1 className="font-bold text-4xl">Crypto <span className=" bg-clip-text bg-gradient-to-r from-indigo-400 to-blue-300 text-transparent"> Trading </span>  Fundamental</h1>
        <p className="my-4 text-base dark:text-yellow-400 text-blue-500 cursor-pointer">Short Course</p>
